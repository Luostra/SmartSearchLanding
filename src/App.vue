...
const faqs = [
  {
    ...
    a: "Это поиск, который учитывает, что вам нужно и для какой задачи. Идея SmartSearch — выделять характеристики из обычной фразы и сопоставлять их с описаниями товаров, даже если формулировки отличаются.",
  },
  {
    ...
    <section class="hero container">
      <div class="hero-copy">
        ...
        <p class="microcopy">
          ...
          <span class="separator-dot">·</span> На ваших словах
        </p>
      </div>
      <div
        class="hero-visual"
    ...
    <section id="possibilities" class="section container possibilities">
      <div class="feature-panel">
        <div class="feature-copy">
          ...
          <p>
            Вы думаете о задаче, а не о названии категории. Мы строим поиск
            вокруг этого.
          </p>
